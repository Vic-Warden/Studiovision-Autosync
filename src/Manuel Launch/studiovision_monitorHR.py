...
PUBLIC_MDB  = Path(r"\\studiovision\Studiov2000\PUBLIC.MDB")
DOCUM_MDB   = Path(r"\\studiovision\Studiov2000\DOCUM.MDB")
...
def main() -> None:
    ...
    if not TRAY_AVAILABLE:
        ...
        try:
            ...
            log.error("MSACCESS.EXE or Studio Vision HR not found.")
        except Exception as e:
            log.error(f"Error launching Studio Vision HR: {e}")
        finally:
